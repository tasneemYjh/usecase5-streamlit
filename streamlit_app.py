...
st.header("gender equality in employment opportunities")
...
st.header("Job Market Demand: Fresh Graduates")
...
st.header("Salary Range: Fresh Graduates")
...
st.header("Full-Time Contracts vs. Remote Work")
